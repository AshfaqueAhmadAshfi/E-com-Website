...
const ReturnPolicy = () => (
    <div className="page"><div className="container" style={{ maxWidth: '900px' }}>
        ...
        {[
            ...
            { title: 'How to Initiate a Return', content: '1. Go to your Order History and select the order. 2. Contact our support team via phone (+880 1531-817299) or Facebook (facebook.com/xlookbd). 3. We will arrange a pickup via our courier partner. 4. Once we receive and inspect the item, your refund will be processed within 3-5 business days.' },
